    ...
    <div class="container-fluid">
        <div class="masonry-blog row">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="masonry-box post-media"  style="height: 100%">
                     <img src="{{ $category->image }}" alt="" class="img-fluid" style="height: 100%">
                     <div class="shadoweffect">
                        <div class="shadow-desc">
                            <div class="blog-meta">
                                <span class="bg-aqua"><a href="blog-category-01.html" title="">{{ $category->translate(LaravelLocalization::getCurrentLocale())->title }}</a></span>
                                <h4><a href="garden-single.html" title="">{{ $category->translate(LaravelLocalization::getCurrentLocale())->content }}</a></h4>
                                <small><a href="garden-single.html" title="">{{ $category->created_at->format('M.j:s , Y') }}</a></small>
                    ...
                    <div class="blog-list clearfix">
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                ...
                                <h4><a href="{{ route('posts.show' , $post->id) }}" title="">{{ $post->translate(LaravelLocalization::getCurrentLocale())->title }}</a></h4>
