...
<body>
        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="garden-index.html"><img src="{{ asset('front_assets/images/version/garden-logo.png') }}" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
    ...
    <script src="{{ asset('front_assets/js/tether.min.js') }}"></script>
   ...
   <!-- MAP & CONTACT -->
    <script src="{{ asset('front_assets/js/garden-map.js') }}"></script>
