...
<!-- Site Metas -->
<title>{{ $setting->translate(LaravelLocalization::getCurrentLocale())->title }}</title>
...
<link href="{{ asset('front_assets/css/colors.css') }}" rel="stylesheet">

<!-- Version Garden CSS for this template -->
<link href="{{ asset('front_assets/css/version/garden.css') }}" rel="stylesheet">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            ...
                            {{-- <a href="garden-index.html"><img src=" {{ $setting->media[0]->getUrl('old-picture') }}"
                                    alt=""></a> --}}
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="{{ route('categories.show', [$cat->id]) }}">
                                    {{ $cat->translate(LaravelLocalization::getCurrentLocale())->title }}</a>
                            </li>
                            @endforeach
                            <li class="nav-item">
