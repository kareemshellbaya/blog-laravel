...
@push('custom_js')
<script>
    let allTxtArea =document.querySelectorAll('.ck_edt');
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="category_id"
                                ...
                                <option @selected(old('parent')==$category->id ) value="{{ $category->id }}">{{
                                    $category->getTranslationsArray()['en']['title']
                                    }}</option>
                                @endforeach
                                    ...
                                    <div id="e_chart_{{ $localeCode }}" class="echart"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                class="form-control mt-15 ck_edt"
